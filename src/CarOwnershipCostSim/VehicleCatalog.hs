...
data CatalogImportSeed = CatalogImportSeed
  { importCatalogId :: String,
    ...
    importFirstYearDepreciationBonus :: Double,
    importResidualValueFloorPercent :: Double,
    importExpectedAnnualMilesForResale :: Double,
    importExtraMileageDepreciationPerMile :: Double,
...
data VehicleCatalogEntry = VehicleCatalogEntry
  { catalogId :: String,
    ...
    catalogFirstYearDepreciationBonus :: Double,
    catalogResidualValueFloorPercent :: Double,
    catalogExpectedAnnualMilesForResale :: Double,
    catalogExtraMileageDepreciationPerMile :: Double,
  ...
  let identity = importIdentity importSeed
   ...
   in VehicleCatalogEntry
        { catalogId = importCatalogId importSeed,
          ...
          catalogFirstYearDepreciationBonus = importFirstYearDepreciationBonus importSeed,
          catalogResidualValueFloorPercent = importResidualValueFloorPercent importSeed,
          catalogExpectedAnnualMilesForResale = importExpectedAnnualMilesForResale importSeed,
          catalogExtraMileageDepreciationPerMile = importExtraMileageDepreciationPerMile importSeed,
