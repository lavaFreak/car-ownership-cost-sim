...
data VehiclePreset = VehiclePreset
  { presetId :: String,
    ...
    presetFuelType :: String,
    presetPurchasePrice :: Double,
    presetCityMilesPerGallon :: Double,
    presetHighwayMilesPerGallon :: Double,
    presetMilesPerGallon :: Double,
    presetElectricDrivingShare :: Maybe Double,
    presetElectricCityMilesPerGallonEquivalent :: Maybe Double,
    presetElectricHighwayMilesPerGallonEquivalent :: Maybe Double,
...
vehiclePresetFromCatalog catalogEntry =
  VehiclePreset
    { presetId = catalogId catalogEntry,
      ...
      presetFuelType = catalogFuelType catalogEntry,
      presetPurchasePrice = catalogPurchasePrice catalogEntry,
      presetCityMilesPerGallon = maybe (catalogCombinedMpg catalogEntry) id (catalogCityMpg catalogEntry),
      presetHighwayMilesPerGallon = maybe (catalogCombinedMpg catalogEntry) id (catalogHighwayMpg catalogEntry),
      presetMilesPerGallon = catalogCombinedMpg catalogEntry,
      presetElectricDrivingShare = catalogElectricDrivingShare catalogEntry,
      presetElectricCityMilesPerGallonEquivalent = catalogElectricCityMpge catalogEntry,
      presetElectricHighwayMilesPerGallonEquivalent = catalogElectricHighwayMpge catalogEntry,
